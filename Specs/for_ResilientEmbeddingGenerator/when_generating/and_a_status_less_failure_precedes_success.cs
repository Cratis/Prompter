...
public class and_a_status_less_failure_precedes_success : Specification
{
    ...
    void Establish()
    {
        _inner = new TransientlyFailingEmbeddingGenerator(failuresBeforeSuccess: 2, status: null);
    ...
    [Fact] void should_retry_the_network_fault_until_it_succeeds() => _inner.Calls.ShouldEqual(3);
}

...
public class and_the_signature_is_not_prefixed : Specification
{
    bool _authentic;

    void Because() => _authentic = WebhookAuth.IsAuthentic("deadbeef", Encoding.UTF8.GetBytes("body"), "s3cret");

...
public class and_the_custom_id_encodes_an_up_vote : Specification
{
    FeedbackClick _result = null!;

    void Because() => _result = FeedbackButton.Parse(FeedbackButton.CustomId(FeedbackVerdict.Up, 987))!;

    [Fact] void should_decode_a_click() => _result.ShouldNotBeNull();
    [Fact] void should_round_trip_the_verdict() => _result.Verdict.ShouldEqual(FeedbackVerdict.Up);

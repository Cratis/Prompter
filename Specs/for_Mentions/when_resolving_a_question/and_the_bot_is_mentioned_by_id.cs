...
public class and_the_bot_is_mentioned_by_id : Specification
{
    ...
    [Fact] void should_strip_the_mention_from_the_question() => _result.Question.ShouldEqual("How do I append an event in Chronicle?");
}

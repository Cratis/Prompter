...
public class and_a_role_is_mentioned : Specification
{
    ...
    void Because() => _result = Mentions.ResolveQuestion($"<@&{BotId}> please look at this", BotId, authorIsBot: false, ChannelId, AskChannelId);
